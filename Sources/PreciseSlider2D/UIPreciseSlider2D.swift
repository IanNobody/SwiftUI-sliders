...
public class UIPreciseSlider2D: UIView {
    ...
    public func updateView(axisXViewModel: PreciseAxis2DViewModel, axisYViewModel: PreciseAxis2DViewModel, axisXDataSource: PreciseAxis2DDataSource?, axisYDataSource: PreciseAxis2DDataSource?, dataSource: PreciseSlider2DDataSource?) {
